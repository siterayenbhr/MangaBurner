...
showHideIco.addEventListener('click', function(){   
        ...
        if (getPasword.type === 'password') {   
            showHideIco.style.background = "url('hiddenPasswdIco.png')";
            showHideIco.style.backgroundRepeat = "no-repeat";
        } else{
            showHideIco.style.background = "url('shownPasswdIco.png')";
            showHideIco.style.backgroundRepeat = "no-repeat";
        }
...
var r = 5;
var brook = 1;
var gokuSound = new Audio('goku_01.mp3')
...
var luffySound = new Audio('luffy_01.mp3');

var brookSound = new Audio('brook_01.mp3')
